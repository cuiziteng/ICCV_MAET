...
class YOLOV3Head(BaseDenseHead, BBoxTestMixin):
    ...
    def loss(self,
        ...
        #for gt_bbox in gt_bboxes:
            #print('1111', gt_bbox.shape)

        num_imgs = len(img_metas)   #batch_size: 8
        #print(num_imgs)
    ...
    def loss_single(self, pred_map, target_map, neg_map):
        ...
        #从neck输出后每一层的prediction map
        #print('shape',pred_map.shape)
        #print('num',num_imgs) batch_size
