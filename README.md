...
python 3.7
pytorch 1.6.0
mmcv 1.1.5 (for example: pip install mmcv-full==1.1.5 -f https://download.openmmlab.com/mmcv/dist/cu102/torch1.6.0/index.html, detail see: https://github.com/open-mmlab/mmcv)
